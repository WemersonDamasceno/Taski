...
import 'package:taski/src/features/home_navigation/bloc/internet_listener_event.dart';
...
class InternetListenerBloc extends Bloc<InternetEvent, InternetState> {
  InternetListenerBloc({required VerifyConnectionUsecase usecase})
  ...
  final VerifyConnectionUsecase _verifyInternetUsecase;
